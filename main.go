...
func main() {
	...
	//	p.Send(event.Info("An event occurred"))
	//	p.Send(status.Msg{Type: status.UPDATE, Msg: "Update message 6"})
	//	time.Sleep(1 * time.Second)
	//
	//	p.Send(event.Debug("a debug message\nand another"))
	//
	//	p.Send(event.Info("An event occurred 2"))
	//	p.Send(status.Msg{Type: status.UPDATE, Msg: "Update message 6"})
	//	p.Send(event.Warn("An event occurred 3"))
	//	p.Send(status.Msg{Type: status.UPDATE, Msg: "Update message 6"})
	//	p.Send(event.Info("An event occurred 4"))
	//	p.Send(event.Error("An event occurred 5"))
	//
