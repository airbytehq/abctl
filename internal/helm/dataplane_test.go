	...
	tests := []struct {
	...
	}{
		{
			...
			wantStrings: []string{
				...
				`clientId: "test-client-id"`,
				`clientSecret: "test-client-secret"`,
				`controlPlaneAuthEndpoint: "https://auth.example.com/realms/airbyte"`,
				`edition: "enterprise"`,
				`type: minio`,
				`namespace: "jobs"`,
			},
		...
		},
		{
			...
			config: &abctl.Config{
				...
				AirbyteAPIHost: "https://api.airbyte.com/v1",
				AirbyteAuthURL: "https://cloud.airbyte.com/auth/realms/my-company",
				Edition:        "cloud",
			},
			wantStrings: []string{
				`airbyteUrl: "https://cloud.airbyte.com"`,
				...
				`clientId: "cloud-client-id"`,
				`clientSecret: "cloud-client-secret"`,
				`controlPlaneAuthEndpoint: "https://cloud.airbyte.com/auth/realms/my-company"`,
				`edition: "cloud"`,
			},
		},
		{
			...
			config: &abctl.Config{
				...
				AirbyteAPIHost: "http://localhost:8000/api/v1",
				AirbyteAuthURL: "http://localhost:8000/auth",
				Edition:        "community",
			},
			wantStrings: []string{
				`airbyteUrl: "http://localhost:8000"`,
	...
	tests := []struct {
	...
	}{
		{
			...
			config: &abctl.Config{
				...
				AirbyteAPIHost: "https://test.example.com/api/v1",
				AirbyteAuthURL: "https://auth.example.com",
				Edition:        "enterprise",
			},
			expectedRepoEntry: repo.Entry{
